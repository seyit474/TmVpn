package com.tmvpn.app.settings
...
object AppSettings {
    ...
    val PREFER_IP_TYPE        = stringPreferencesKey("prefer_ip_type")
    ...
    val NOISE_PACKET   = stringPreferencesKey("noise_packet")
    val NOISE_DELAY    = stringPreferencesKey("noise_delay")
